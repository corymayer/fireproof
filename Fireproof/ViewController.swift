...
//        sceneView.showsStatistics = true
        ...
        // Set up Vision Model
        guard let selectedModel = try? VNCoreMLModel(for: Inceptionv3().fritz().model) else { // (Optional) This can be replaced with other models on https://developer.apple.com/machine-learning/
